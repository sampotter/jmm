...
//   2020-09-12: some formatting changes, switch to double
//
// Acknowledgement: Many thanks to Pierre Terdiman for suggestions and
// discussions on how to optimize code.  Thanks to David Hunt for
// finding a ">="-bug!
//
