...
void eik2m1_add_trial(eik2m1_s *eik, size_t l, jet21t jet);
void eik2m1_add_valid(eik2m1_s *eik, size_t l, jet21t jet);
...
jet21t const *eik2m1_get_jet_ptr(eik2m1_s const *eik);
